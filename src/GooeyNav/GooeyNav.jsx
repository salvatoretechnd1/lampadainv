...
/**
 * GooeyNav — variante adaptada para barra de abas vertical (ícone + label),
 * com suporte a badge de notificação e uso controlado (activeId/onChange).
 *
 ...
 * colors: { active, activeSoft, muted, badge } — cores do tema (hex)
 */
const GooeyNav = ({
  items,
  activeId,
  ...
  const handleKeyDown = (e, index, id) => {
    if (e.key === 'Enter' || e.key === ' ') {
      ...
      if (liEl) {
        handleClick({ currentTarget: liEl }, index, id);
      }
    }
  };
